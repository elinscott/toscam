...
C                  of the fit of degree N at each of the  X(I) .
...
C***END PROLOGUE  DPOLFT
     ...
     * K4PI,K5,K5PI,KSIG,M,MAXDEG,MOP1,NDEG,NDER,NFAIL
      REAL(16) TEMD2
      REAL(16) TEMD1,W11,W1
      REAL(16) DEGF,DEN,ETST,F,FCRIT,SIG,SIGJ,SIGJM1,SIGPAS,TEMP,XM
      REAL(8)  X(*),Y(*),W(*),R(*),A(*),EPS,YP
      REAL(16) CO(4,3),WWW
      SAVE CO
