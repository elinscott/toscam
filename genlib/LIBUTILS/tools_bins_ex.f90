...
!
  ...
  write ( *, '(a)' ) '  Tests the routines in the BINS library.'
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST09'
  write ( *, '(a)' ) '  R8VEC_BIN computes bins for a DVEC.'
...
!*****************************************************************************80
!
!! TEST10 tests R8VEC_BIN_EVEN, R8VEC_BINNED_REORDER, R8VEC_BINNED_SORT.
!
  implicit none
  ...
  write ( *, '(a)' ) '    to correspond to the bin ordering.'
  write ( *, '(a)' ) '  R8VEC_BINNED_SORT can sort the array'
...
!  Get the test points.
!
  write ( *, * ) 'DEBUG: About to call triangulation_sample_2d.'
  call triangulation_sample_2d ( num_pts, xc, num_tri, nod_tri, &
    ntest, seed, xd, td )
  write ( *, * ) 'DEBUG: Returned from triangulation_sample_2d.'
  write ( *, '(a)' ) ' '
