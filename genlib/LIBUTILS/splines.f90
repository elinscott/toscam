...
!*****************************************************!
 ...
 integer :: i,j,k,l,siz,ndim,ninter
  siz=size(xin(:))
  do i=1,size(x)
   call spline_overhauser_val ( 1, siz, xin, yin, x(i), y(i))
  enddo
 end subroutine
 ...
 integer :: i,j,k,l,siz,ndim,ninter
  siz=size(xin(:))
  call spline_overhauser_val ( 1, siz, xin, yin, x, y)
 end subroutine
...
!*****************************************************!
 ...
 do j=1,u(2)
  do l=1,size(xx)
   call spline_overhauser_val ( 1, size(xin), xin, real(yin(i,j,k,:)), xx(l), ttr)
   call spline_overhauser_val ( 1, size(xin), xin, aimag(yin(i,j,k,:)), xx(l), tt)
