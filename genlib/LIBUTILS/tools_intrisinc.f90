!    * F90_INTRINSICS_PRB tests FORTRAN intrinsic routines.
!    * TEST_ABS tests ABS.
...
!    * TEST_SIN_D8 tests SIN on real ( kind = 8 ) arguments.
...
!*****************************************************************************
!
!! MAIN is the main program for F90_INTRINSICS_PRB.
!
!  Discussion:
!
!    F90_INTRINSICS_PRB tests FORTRAN intrinsic routines.
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'F90_INTRINSICS_PRB'
  write ( *, '(a)' ) '  FORTRAN90 version'
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) '  Test FORTRAN90 intrinsic routines.'
...
!  Discussion:
!
!    The FORTRAN90 function aimag returns the aimaginary part of a
!    complex number.
!
!  Modified:
!
...
!
  ...
  write ( *, '(a)' ) '  aimaginary part of a complex number.'
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) '                  X                      aimag(X)'
  write ( *, '(a)' ) ' '
  do i = 1, 10
...
!
  ...
  write ( *, '(a)' ) '  complex number formed by real and aimaginary parts.'
  write ( *, '(a)' ) ' '
...
!
  ...
  a2_i4 = cshift ( a1_i4, (/ 1, 2 /) )

  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) '  a2_i4 = cshift ( a1_i4, (/ 1, 2 /) ):'
  write ( *, '(a)' ) ' '
  do i = 1, 4
...
!
  ...
  a2_i4 = eoshift ( a1_i4, (/ 1, 2 /), 77 )

  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) '  a2_i4 = eoshift ( a1_i4, (/ 1, 2 /), 77 ):'
  write ( *, '(a)' ) ' '
  do i = 1, 4
    write ( *, '(2x,5i4)' ) a2_i4(i,1:5)
  end do
